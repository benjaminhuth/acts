...
class GNNTracccFullChainAlgorithm final : public IAlgorithm {
 public:
  struct Config {
  ...
  GNNTracccFullChainAlgorithm(Config cfg, Acts::Logging::Level lvl);

  ~GNNTracccFullChainAlgorithm() override = default;
