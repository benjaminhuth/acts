...
int main() {
  ...
  const auto logger = Acts::getDefaultLogger("GsfActorTest", Acts::Logging::VERBOSE);
  ...
  // Options
  using GSF = Acts::GsfActor;
  
  using MultiActionList =
      Acts::ActionList<MultiSteppingLogger, GSF/*, Acts::MaterialInteractor*/>;
