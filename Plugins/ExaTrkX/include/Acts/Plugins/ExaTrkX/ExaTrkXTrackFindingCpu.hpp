...
/// @brief Class implementing the Exa.TrkX track finding algorithm based on libtorch on CPU
class ExaTrkXTrackFindingCpu final : public ExaTrkXTrackFindingBase {
 public:
  ...
  ExaTrkXTrackFindingCpu(const Config& config);

  /// Destructor
  ~ExaTrkXTrackFindingCpu();
